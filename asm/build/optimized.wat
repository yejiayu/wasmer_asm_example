(module
 ...
 (data (i32.const 288) "\14\00\00\00\01\00\00\00\01\00\00\00\14\00\00\00t\00e\00s\00t\00 \00e\00r\00r\00o\00r")
 (data (i32.const 336) "\"\00\00\00\01\00\00\00\01\00\00\00\"\00\00\00a\00s\00s\00e\00m\00b\00l\00y\00/\00i\00n\00d\00e\00x\00.\00t\00s")
 (data (i32.const 400) "\04\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\98\04\t")
 ...
 (func $~lib/map/Map<i32,i32>#constructor (; 17 ;) (result i32)
  (local $0 i32)
  i32.const 24
  i32.const 3
  call $~lib/rt/tlsf/__alloc
 ...
 (func $~lib/util/hash/hash32 (; 18 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 255
  i32.and
 ...
 (func $~lib/map/Map<i32,i32>#find (; 19 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  local.get $0
  i32.load
  local.get $2
  local.get $0
 ...
 (func $~lib/map/Map<i32,i32>#rehash (; 20 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/map/Map<i32,i32>#set (; 21 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  local.get $0
 ...
 (func $assembly/index/add (; 22 ;) (param $0 i32) (param $1 i32) (result i32)
